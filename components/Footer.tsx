        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/login" className="text-slate-300 hover:text-white transition-colors">Desafíos</a></li>
              <li><a href="/login" className="text-slate-300 hover:text-white transition-colors">Comunidad</a></li>
            </ul>
          </div>
